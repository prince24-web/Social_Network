...
export function HeroSection() {
  return (
    <div className="relative isolate pt-14 dark:bg-gray-900 min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="py-24 sm:py-32 lg:pb-40 relative z-10 text-center">
        ...
        <div className="hidden sm:mb-8 sm:flex sm:justify-center">
          <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-400 ring-1 ring-white/10 hover:ring-white/20">
            ...
            <Link href="/manual" className="font-semibold text-blue-400 hover:text-blue-300">
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            href="/start"
            className="rounded-full bg-blue-600 px-8 py-3.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/30 hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-400 transition-all duration-300 hover:scale-105"
          >
            Start Battling
          </Link>
          <Link
            href="/demo"
            className="group flex items-center gap-2 text-sm font-semibold leading-6 text-white hover:text-blue-300 transition-colors"
          >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[500px] border-t border-blue-500/20 rounded-[100%] opacity-50 blur-3xl pointer-events-none -z-10 bg-gradient-to-b from-blue-900/10 to-transparent"></div>
